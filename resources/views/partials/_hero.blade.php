...
<div class="z-10">
    ...
    <div>
        @guest
            <a href="{{ url('/login') }}" class="inline-block border-2 border-white text-white py-2 px-4 rounded-xl uppercase mt-2 hover:text-black hover:border-black">
                Log in om jouw blog te plaatsen
            </a>
        @endguest
    </div>
</div>
